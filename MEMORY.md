...
### 12.05.2026 — Daily job successful, 6 published
- cleanup_milanuncios --execute: to_delete=4, ok=262, deleted=4, errors=0.
- Cleared items in Notion, all with real manual-delete Milanuncios URLs:
  - BESTOPE MIX 10 mm Lockenstab... → https://www.milanuncios.com/anuncios/r592685506.htm (`price_too_low 11.0`)
  - Braun Mini Depiladora Facial FS1000... → https://www.milanuncios.com/anuncios/r592685388.htm (`price_too_low 13.0`)
  - Cecotec IceMaster 12000 → https://www.milanuncios.com/anuncios/r594611117.htm (`price_too_low 0.0`)
  - Tefal Filtra FR511170... → https://www.milanuncios.com/anuncios/r590648243.htm (`out_of_stock`)
- cleanup_sold_products returned `count=0`.
- Published 6/7 via `mixmix` profile on port `18801` using `inject_photo_cdp.py --port 18801` + `publish_via_cdp.py`:
  1. SPC Harmony 4G..., 30€ → https://www.milanuncios.com/anuncios/r594763941.htm
  2. Beurer LV 50 Fresh Breeze..., 27€ → https://www.milanuncios.com/anuncios/r594914578.htm
  3. SPC Titan..., 17€ → https://www.milanuncios.com/anuncios/r594914742.htm
  4. Cecotec Conga RockStar 3000 Mattress, 25€ → https://www.milanuncios.com/anuncios/r594915004.htm
  5. SPC Fortune 2..., 16€ → https://www.milanuncios.com/anuncios/r594915187.htm
  6. Cecotec Aspirador de Sólidos y Líquidos de 30 L..., 40€ → https://www.milanuncios.com/anuncios/r594915337.htm
- No skips, no publish errors.
